...
export const members: Member[] = [
  ...
  },
  {
    id: 'hiloki',
    nickname: 'hiloki',
    realName: 'Hiroki Tani',
    bio: 'Design Engineer & Coffee, Shiba-dog lover',
    avatarSrc: '/avatars/hiloki.jpg',
    sources: ['https://zenn.dev/hiloki/feed', 'https://note.com/hilokit/rss'],
